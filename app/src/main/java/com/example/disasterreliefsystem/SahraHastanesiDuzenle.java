...
public class SahraHastanesiDuzenle extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    AdapterSahraHastanesi adapterSahraHastanesi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterSahraHastanesi = new AdapterSahraHastanesi(this,list);
