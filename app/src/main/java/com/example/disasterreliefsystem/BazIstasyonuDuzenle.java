...
public class BazIstasyonuDuzenle extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    AdapterBazIstasyonu adapterBazIstasyonu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterBazIstasyonu = new AdapterBazIstasyonu(this,list);
