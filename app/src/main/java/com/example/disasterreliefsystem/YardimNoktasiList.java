...
public class YardimNoktasiList extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    AdapterYardimNoktasiMain adapterYardimNoktasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapterYardimNoktasi = new AdapterYardimNoktasiMain(this,list);
